...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Decode map- and sensor-based road topics, establish geometric "
            "correspondence, calculate residuals, and fit a descriptive Gaussian."
        )
    )
