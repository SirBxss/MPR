"""Concise diagnostics for the v0.13 expanded sequential dataset."""
...
def plot_expanded_sequence_diagnostics(
    path: Path,
    *,
    ...
    """Show retained/excluded profiles, sequence lengths, and heading evidence."""
    ...
    axes[1].set_title("Quality-gated sequence lengths")
    ...
    figure.suptitle("CONFIDENTIAL — v0.13 pre-model quality-gated sequences")
...
__all__ = ["plot_expanded_sequence_diagnostics"]
